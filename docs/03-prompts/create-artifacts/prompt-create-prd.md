...
4.  **Save PRD:** Save the generated document as `prd-[feature-name].md` inside the `docs/software-engineering/example-project/features/[feature-name]/prd/` directory.
...
- **Format:** Markdown (`.md`)
- **Location:** `docs/software-engineering/example-project/features/[feature-name]/prd/`
...
4. If you are making assumptions, list them clearly.
5. Version everything ie This is PRD v 0.1 - exploritory, This is version 0.2 - validated, etc.
